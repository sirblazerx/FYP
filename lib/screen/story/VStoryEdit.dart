...
import 'package:app/screen/story/EditStory.dart';
import 'package:app/screen/story/comments.dart';
                        ...
                        child: Column(
                          ...
                          children: [
                           ...
                           IconButton(icon: Icon(Icons.edit), onPressed: (){
                             ...
                             Navigator.of(context).push(MaterialPageRoute(builder: (context) => (EditStory(storyid: widget.storyid,img: snapshot.data['img'],vid: snapshot.data['uyoutube'],fb: snapshot.data['ufacebook'],))));
